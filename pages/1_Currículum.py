...
col_222.write("\n")
col_222.link_button("**Implementación**: usando conocimientos de Inteligencia Aritificial sobre el lenguaje de Python.")
...
col_222.write("\n")
col_222.link_button("**Implementación**: usando Docker con el lenguaje Kafka.")
st.write("- **Deep Neural Network**")
col_111, col_222 = st.columns(2)
col_111.write("**Objetivo**: cconstrucción de un modelo de red de neuronas.")
col_222.write("\n")
col_222.link_button("**Implementación**: en Jupyter Notebook en el lenguaje de Python.")
...
col_222.write("\n")
col_222.link_button("**Implementación**: en Coppelia Sim con el lenguaje de Python.")
